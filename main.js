...
( () => {
  ...
  \************************/
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */
        var _components_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_components.js */
        "./src/js/_components.js");
        /* harmony import */
        var page_flip__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! page-flip */
        "./node_modules/page-flip/dist/js/page-flip.browser.js");

        const singleFlip = new page_flip__WEBPACK_IMPORTED_MODULE_1__.PageFlip(document.getElementById('single-book'),{
            width: 400,
        ...
        const prevBtn = document.querySelector('.book__nav-btn-back');
        const nextBtn = document.querySelector('.book__nav-btn-next');
        const pageIndicator = document.querySelector('.book_nav-text');

        let isAnimating = false;

        function updatePageIndicator() {
            const currentPage = singleFlip.getCurrentPageIndex() + 1;
            const totalPages = singleFlip.getPageCount();
        ...
        function flipWithAnimation(direction) {
            ...
            if (direction === 'next') {
                singleFlip.flipNext('top');
            } else {
                singleFlip.flipPrev('top');
            }
            
            setTimeout(() => {
                isAnimating = false;
                updatePageIndicator();
            }, singleFlip.getSettings().flippingTime + 100);
        }

        prevBtn.addEventListener('click', () => {
            flipWithAnimation('prev');
        });

        nextBtn.addEventListener('click', () => {
            flipWithAnimation('next');
        });

        singleFlip.on('flip', (e) => {
            updatePageIndicator();
        });

        singleFlip.on('changeState', (e) => {
            const state = e.data;
